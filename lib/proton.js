...
Server.prototype.start = function () {
    if (this._daemonise) {
        this.daemoniser()(this._pidfile, this._uid, this._gid, this._logdir);
    }
...
Server.prototype.daemoniser = function () {
    if (this._daemoniser) {
        return this._daemoniser;
    }
    return function daemonise (pidfile, uid, gid, logdir) {
...
Server.prototype.setDaemoniser = function (daemoniser) {
    this._daemoniser = daemoniser;
};
